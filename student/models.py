...
class student(models.Model):
    ...
    birthyear = models.IntegerField(verbose_name= "سال تولد", max_length=4)
    birthmonth = models.IntegerField(verbose_name = "ماه تولد",max_length=2)
    birthdany = models.IntegerField(verbose_name="روز تولد", max_length=2)
    enter_year = models.IntegerField(verbose_name= "سال ورود",max_length= 4)
